...
<head>
    ...
    <style type="text/css">
        ...
        .con1_1_1{width:600px;height:60px;background-color: #e1882a;overflow: hidden;float: left;}
        ...
        .co2_1cos{width:138px;height:35px;border-top: 2px solid #e1882a;background-color: #FAFAFA;border-left: 1px solid #EAEAEA;border-right: 1px solid #EAEAEA;}
        ...
        .co2_2{width:1040px; margin-left: 20px;float:left;border-top: 2px solid #e1882a;}
        ...
        .co2_content li.active{background-color: #e1882a;}
        ...
        .tcdPageCode a:hover{text-decoration: none;border: 1px solid #e1882a;}
        .tcdPageCode span.current{display: inline-block;height: 25px;line-height: 25px;padding: 0 10px;margin: 0 2px;color: #fff;background-color: #e1882a;	border: 1px solid #e1882a;border-radius: 4px;vertical-align: middle;}
...
<div class="content2">
    ...
    <div class="co2_2">
        <p ><span style="margin-left:20px;"><i class="iconfont f18" style="color:#e1882a;">&#xe60e;</i></span><span style="margin-left:10px;color:#444343;"><a href="${baseurl}">首页</a></span><span><i class="iconfont" style="color:#444343;margin-left:15px;">&#xe60d;</i></span><span style="margin-left:20px;color:#444343;">
            <c:choose>
        ...
        <div class="co2_content">
            ...
            <a style="color:#e1882a;" id="showMore" href="#">更多<span><i class="iconfont" style="color:#444343;margin-left:10px;">&#xe610;</i></span></a>
        </div>
            </c:if>
