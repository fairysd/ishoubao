...
<header class = "Global_header">
    ...
    <div class = "out_box header_nav">
        ...
        <ul class = "main_nav">
            ...
            <li>
                <a href = "${baseurl}category/08d2d4cbf39748f08d56b26ba29266aa/0">宝贝回收</a>
            ...
            <li>
                <a href = "${baseurl}luxury">护理</a>
            </li>
            <li>
                <a href = "${baseurl}help/lxwm">联系我们</a>
            </li>
            <li>
                <a href = "${baseurl}selcity/856">返回主站</a>
            </li>
        </ul>
    </div>
</header>
