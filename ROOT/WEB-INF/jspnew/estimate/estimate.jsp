...
<div class = "apply_out">
    <form name="productOrderForm" id="productOrderForm" method="post" action="${baseurl}estimate/order">
        ...
        <input type="hidden" name="cardno" id="submitcardno" value="${userEstimate.cardno}"/>
        </form>
    <div id = "ectradeapply">
                ...
                <ul class = "collection">
                    <li>
                        ...
                        <ul class = "item-wrap clearfix">
                            ...
                            <li class = "verify-mobile pickup-express-only">
                                <div class = "item">
                                    <input type = "text" name="cardno" id="cardno" maxlength = "18" placeholder = "身份证号码" class = "placeholder">
                                </div>
                            </li>
                        </ul>
                    </li>
...
//               console.log("银行:"+bankName);
               ...
               $("#submitcardno").attr("value", $("#cardno").val());
