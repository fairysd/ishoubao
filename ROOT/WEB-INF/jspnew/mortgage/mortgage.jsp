...
<div class = "apply_out">
    <form name="productOrderForm" id="productOrderForm" method="post" action="${baseurl}estimate/order">
        ...
        <input type="hidden" name="mortgageInterestDay" id="mortgageInterestDay" value="${mortgageDayInterest}"/>
        </form>
    <div id = "ectradeapply">
                ...
                <ul class = "collection">
                    ...
                    <li>
                        ...
                        <ul class = "item-wrap clearfix">
                            <li class = "verify-username">
                                <div class = "item">
                                    <input type = "text" name="mortgageStarttimeInput" id="mortgageStarttimeInput" placeholder = "开始时间" class = "placeholder" onfocus="WdatePicker({minDate:'%y-%M-%d'})" readonly="readonly">
                                </div>
                                <p>周期不少于7天,手续费${mortgageDayInterest}%/天</p>
                            </li>
                            <li class = "verify-username">
                                <div class = "item">
                                    <input type = "text" name="mortgageEndtimeInput" id="mortgageEndtimeInput" placeholder = "结束时间" class = "placeholder" onFocus="popDateSel()" readonly="readonly">
                                </div>
                                <p>预计手续费<i id="expertEarnings"></i></p>
                            </li>
                        </ul>
                    </li>
        ...
        <!-- 回收清单 -->
        <h2 class = "cart-list-title">物品清单</h2>
...
<script>
    function popDateSel() {
        ...
        WdatePicker({onpicked:computeExpertEarnings(),minDate:'#F{$dp.$D(\'mortgageStarttimeInput\',{d:7});}'});
    }
...
//                checkMobile();
       ...
       $("#js-submit").on({
           "click":function(){
               ...
               if (!RQcheck($("#mortgageStarttimeInput").val())) {
                   alert("请选择正确的开始日期");
                   return false;
               }
               if (!RQcheck($("#mortgageEndtimeInput").val())) {
                   alert("请选择正确的结束日期");
                   return false;
               }
...
//               console.log("银行:"+bankName);
               ...
               $("#mortgageStarttime").attr("value", $("#mortgageStarttimeInput").val());
               $("#mortgageEndtime").attr("value", $("#mortgageEndtimeInput").val());
...
<script type="text/javascript" src="${baseurl}res/js/datepicker/WdatePicker.js"></script>
