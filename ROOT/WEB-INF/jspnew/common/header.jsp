...
<header class = "Global_header">
    ...
    <div class="mywrapper toolbar">
       <div class="myrow">
           <div class = "city_box">
               <div class = "city_select">门店 [<span><c:if test="${not empty areainfo.name and sessionScope.subpage == '1'}">${areainfo.name}</c:if><c:if test="${not(not empty areainfo.name and sessionScope.subpage == '1')}">苏州市</c:if></span>]</div>
    ...
    <div class = "out_box header_nav">
        <h1 class = "logo"><a href="${baseurl}"><img src = "${baseurl}res/images/v2/logo.gif" alt = "爱收宝"></a><img class="smp" src="${mybaseurl}/res/images/new/2smpjypt.png"/></h1>
