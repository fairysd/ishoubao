...
<head>
    ...
    <style>
        ...
        .zly_lef1{width:100%;height: 90px;background-color: #996600;overflow:hidden;}
        ...
        .zlylef2_5 img{width:760px;height:130px;margin-top: 100px;}
        ...
        .zlylef2_7 img{width:760px;height:130px;margin-top: 70px;}
        ...
        .zlylef2_11{width:840px;height:70px;margin:auto;border-bottom: 1px solid #DCDCDC;border-top: 1px solid #DCDCDC;margin:auto;border-left: 5px solid #996600;margin-top: 30px;}
        ...
        .zlylef11_2{width:80px;height:25px;float:left;background-color: #F3D39C;border-radius:5px;border: 1px solid #996600;text-align: center;margin-left: 15px;margin-top: 22px;}
        .zlylef11_2 a{font-size: 12px;text-decoration:none;color:#996600;line-height: 25px;}
        .zlylef2_12{width:760px;margin:40px auto;}
        .zlylef2_12 p{margin-top: 5px;margin-bottom: 0;font-size: 12px;}
        .radio{border-radius:9px;background-color: #E0C66B;font-size: 16px;color:#FFFFFF;padding-left: 3px;padding-right: 3px;}
        ...
        .zlt_rido1{width:40px;height:40px;background-color: #996600;text-align: center;margin-top: 15px;margin-left: 15px;float:left;}
        ...
        .zlylef2_13{width:840px;height:70px;margin:auto;border-bottom: 1px solid #DCDCDC;border-top: 1px solid #DCDCDC;margin:auto;border-left: 5px solid #996600;margin-top: 30px;}
        ...
        .zlylef14_1,.zlylef14_2,.zlylef14_3,.zlylef14_4{width:175px;height:220px;float:left;border-bottom: 4px solid #996600;}
    ...
    <div class="zly_content">
        <div class="zltco_left">
            ...
            <div class="zly_lef2">
                ...
                <div class="zlylef2_2">
                    <a name="zly_jyfs"></a>
                    <img src="${baseurl}res/images/new/estimate/sp_2.jpg" alt="">
                </div>
                <div class="zlylef2_3" >
                    <div id="allmap"></div>
                </div>
                ...
                <div class="zlylef2_5" >
                    <img src="${baseurl}res/images/new/estimate/sp_4.jpg" alt="">
                </div>
                <div class="zlylef2_6" >
                    <div class="zlylef6_1">
                        <div class="zly_shop">
